...
arrPages=("about-us" "calendar" "links" "research" "publications" "news" "people" "surveys" "join-us" "contact")
arrPeople=("anuruddhika" "beshan" "chathurika" "drive" "erandi" "gayanthi" "gihan" "harshana" "insaf" "isuru" "janaka" "kaveen" "kavindu" "mevan" "navodini" "parakrama" "pipuni" "praditha" "rahal" "roshan" "rumali" "samath" "sankani" "suren"  "survey1" "survey2" "vijitha" "mallika" "sakunthala" "dilshan" "yasiru" "vision-draft")
