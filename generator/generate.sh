...
arrPeople=("anuruddhika" "beshan" "gihan" "harshana" "insaf" "isuru" "janaka" "kaveen" "kavindu" "mevan" "parakrama" "praditha" "roshan" "rumali" "samath" "suren" "vijitha" "mallika" "sakunthala" "dilshan")
