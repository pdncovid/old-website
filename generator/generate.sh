...
arrPeople=("anuruddhika" "beshan" "gayanthi" "gihan" "harshana" "insaf" "isuru" "janaka" "kaveen" "kavindu" "mevan" "parakrama" "praditha" "rahal" "roshan" "rumali" "samath" "suren" "vijitha" "mallika" "sakunthala" "dilshan")
