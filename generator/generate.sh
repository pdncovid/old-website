...
arrPeople=("anuruddhika" "beshan" "gihan" "harshana" "insaf" "isuru" "jbe" "kaveen" "kavindu" "mevan" "parakrama" "praditha" "roshan" "rumali" "samath" "suren" "vijitha" "mallika" "sakunthala" "dilshan")
